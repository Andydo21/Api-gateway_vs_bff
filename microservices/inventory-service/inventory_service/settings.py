...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-inventory-service-key')
...
# No authentication needed - Inventory Service only receives requests from BFF (internal)
REST_FRAMEWORK = {
