...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-recommendation-service-key')
...
# No authentication needed - Recommendation Service only receives requests from BFF (internal)
REST_FRAMEWORK = {
