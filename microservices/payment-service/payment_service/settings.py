...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-payment-service-key')
...
# No authentication needed - Payment Service only receives requests from BFF (internal)
REST_FRAMEWORK = {
