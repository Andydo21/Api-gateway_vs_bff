...
urlpatterns = [
    ...
    path('startups/<int:startup_id>/reviews/', views.startup_reviews, name='startup_reviews'),
    path('startups/<int:startup_id>/reviews/summary/', views.startup_reviews_summary, name='startup_reviews_summary'),
